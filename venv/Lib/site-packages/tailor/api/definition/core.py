...
class PythonTask(SingleTask):
    ...
    output_extraction : dict, optional
        An expression to extract parts of the return value of the action. The keys of the dictionary are used as tags,
...
class DAGTask(GroupTask):
    ...
    name : str, optional
        Workflow name. A default name is used if not provided.
    parents : TaskDefinition or list, optional
